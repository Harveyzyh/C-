...
    public static class AesCrypto
    {
        private static string key_def = @"HarveyZYH00Flask";
        ...
        public static string Decrypt(string encryptedData, EncodingStrOrByte.EncodingType encodingType = EncodingStrOrByte.EncodingType.UTF8)
        {
            string key = key_def;
            string iv = key_def;
