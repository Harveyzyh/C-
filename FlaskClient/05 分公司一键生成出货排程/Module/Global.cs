public class Global_Const //静态量配置
{
    ...
    public const string strConnection_Y_LS = "Server=183.56.211.111;initial catalog=lserp-LY;user id=sa;password=DGlsdnkj168;Connect Timeout=5";

    public const string strConnection_Y_WGDB = "Server=183.56.211.111;initial catalog=WG_DB;user id=sa;password=DGlsdnkj168;Connect Timeout=5";

    public const string strConnection_Y_ROBOT = "Server=183.56.211.111;initial catalog=ROBOT_TEST;user id=sa;password=DGlsdnkj168;Connect Timeout=5";

    public const string strConnection_Y_COMFORT = "Server=183.56.211.111;initial catalog=WG_DB;user id=sa;password=DGlsdnkj168;Connect Timeout=5";
    ...
    public static class ConnStrObject
    {
        ...
        public static string YLs { get { return strConnection_Y_LS; } }
    }
}