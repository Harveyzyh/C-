...
{
    public partial class 录入销货单_获取单据信息 : Form
    {
        ...
        private string Title = 录入销货单.Title;
        private string Mode = 录入销货单.Mode;
        ...
        private void CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            录入销货单.GetMain = dt.Rows[Index][0].ToString();
            录入销货单.GetOther = dt.Rows[Index][1].ToString();
            this.Close();
        }
