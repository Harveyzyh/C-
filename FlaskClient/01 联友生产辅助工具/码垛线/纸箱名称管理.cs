...
namespace HarveyZ.生管码垛线
{
    public partial class 纸箱名称管理 : Form
    {
        ...
        {
            string slqStr = @"SELECT BoxName 纸箱名称, Spec 工艺编码, Valid 有效码 FROM BoxNameCode ORDER BY BoxName ";
        ...
        {
            string slqStr = @"UPDATE BoxNameCode SET Spec = '{1}', Valid = '{2}' WHERE BoxName = '{0}' ";
