...
namespace HarveyZ.生管排程
{
    public partial class 排程物料导出_生产 : Form
    {
        ...
        {
            string sqlStr = @"SELECT SCPLAN.SC003 排程日期, RTRIM(INVMB.MB001) 成品品号, RTRIM(INVMB.MB002) 成品品名, RTRIM(INVMB.MB003) 成品规格, INVMB.UDF12 产品系列, 
            ...
            sqlStr += @"AND MOCTB.TB011 IN ('1', '2') 
                            AND MOCTA.TA011 != 'y' 
                            GROUP BY SCPLAN.SC003, RTRIM(INVMB.MB001), RTRIM(INVMB.MB002), RTRIM(INVMB.MB003), INVMB.UDF12, 
