...
{
    public partial class 录入客户订单_获取单据信息 : Form
    {
        ...
        private string Title = 录入客户订单.Title;
        private string Mode = 录入客户订单.Mode;

        public 录入客户订单_获取单据信息()
        {
            InitializeComponent();
            Init();
        ...
        private void CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            录入客户订单.GetMain = dt.Rows[Index][0].ToString();
            录入客户订单.GetOther = dt.Rows[Index][1].ToString();
            this.Close();
        }
