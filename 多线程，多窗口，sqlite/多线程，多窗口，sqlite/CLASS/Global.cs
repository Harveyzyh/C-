public class Global_Var //全局变量配置
{
    ...
    public static string strConnection_ROBOT = "";

    public static string Login_UID = "";

    public static string ROBOT_TEST_MODE = "";
    public static string ROBOT_PRINT_MODE = "";
}
...
public class Global_Const //静态量配置
{
    ...
    public const string strConnection_ERP = "Server=192.168.0.99;initial catalog=COMFORT;user id=sa;password=comfortgroup2016{;Connect Timeout=5";
    #endregion
